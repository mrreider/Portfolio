...
{
    //selecting primary non IO function
    // LCD_SCK
...
void HAL_LCD_SpiInit(void)
{
    ...
    EUSCI_B0->CTLW0 = EUSCI_B_CTLW0_CKPH | EUSCI_B_CTLW0_MSB | EUSCI_B_CTLW0_MST
            | EUSCI_B_CTLW0_MODE_0 | EUSCI_B_CTLW0_SYNC
            | EUSCI_B_CTLW0_SSEL__SMCLK //| EUSCI_B_CTLW0_STEM using 3 pin dont need to configure
            | EUSCI_B_CTLW0_SWRST;
